...
| 4 | Bằng chứng đầu | Bằng chứng chính: khảo sát/phỏng vấn 7 giảng viên/coach, 6/7 từng phát hiện lớp chưa hiểu muộn sau khi đã chuyển phần, cuối buổi hoặc khi chấm bài; một quote tiêu biểu: "Câu hỏi dạng 'các em hiểu chưa?' thường chỉ nhận được im lặng hoặc câu trả lời đồng ý nên dễ tạo cảm giác lớp đã theo kịp." Bằng chứng bổ trợ từ VLearn chatbot log: 879/2.555 câu tự gõ có dấu hiệu cần giải thích/làm rõ, nhưng `understanding_level` và `ask_probing_question` chỉ xuất hiện 6/3.097 lượt. |
